...
VOID CSE_CAT_SEARCH_MGR::OnbSEARCH() 
{
	...
	GetControlData(_T("CM_연속_등록_검색"), _T("차수번호시작"), strWorkNo1);
	GetControlData(_T("CM_연속_등록_검색"), _T("차수번호끝"), strWorkNo2);
	if(  OpenMode == 2) // 원부 대장관리
	{
		GetControlData(_T("CM_연속_등록_검색"), _T("원부번호_시작"), strpreGroup1);
		strpreGroup2=_T("");
	}
	else
	{
		GetControlData(_T("CM_연속_등록_검색"), _T("가원부번호시작"), strpreGroup1);
		GetControlData(_T("CM_연속_등록_검색"), _T("가원부번호끝"), strpreGroup2);		 
	}
	...
	{
		SetControlData(_T("CM_연속_정리_등록_메인"), _T("차수번호"), strWorkNo1);
		SetControlData(_T("CM_연속_정리_등록_메인"), _T("가원부번호"), strpreGroup1);
	}
	else if ( OpenMode == 1 ) //가원부 관리 
	{
		SetControlData(_T("CM_연속_정리_가원부_메인"), _T("차수번호"), strWorkNo1);
		SetControlData(_T("CM_연속_정리_가원부_메인"), _T("가원부번호"), strpreGroup1);
	}
	else if ( OpenMode == 2 ) //원부대장 관리 
	{
		SetControlData(_T("CM_연속_정리_원부_메인"), _T("원부번호"), strWorkNo1);
	}
...
*/
		...
		//원부번호 
		GetControlData(_T("CM_연속_등록_검색"), _T("원부번호_시작")   , sAccessionNoStart); 
...
// 	}
	...
	//가원부 번호
	GetControlData(_T("CM_연속_등록_검색"), _T("가원부번호시작"), preGroup1);
	GetControlData(_T("CM_연속_등록_검색"), _T("가원부번호끝")  , preGroup2);
