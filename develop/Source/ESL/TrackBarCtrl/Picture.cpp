...
#define ERROR_TITLE _T("ERROR") // Error Title (Related To This Class)...
...
//=============================================================================
{
	...
	if(PictureFile.Open(sFilePathName, CFile::modeRead | CFile::shareDenyNone | CFile::typeBinary, &e)) //공유를 위해 shareDenyNone 추가함
	{
