...
/////////////////////////////////////////////////////////////////////////////
// CSIBarcodeCtrl::Draw - Drawing function
INT CSIBarcodeCtrl::IsCheckSum( INT iStyle )
{
EFS_BEGIN
...
long CSIBarcodeCtrl::CheckSumInit( INT iStyle, INT nLength )
{
EFS_BEGIN
...
long CSIBarcodeCtrl::CheckSum( INT iStyle, long cs, INT iChar, INT iCount )
{
EFS_BEGIN
...
VOID CSIBarcodeCtrl::DrawBar( CDC * pdc, CRect& rcBounds, CBrush * brush, INT x, INT nWidth )
{
EFS_BEGIN
...
INT CSIBarcodeCtrl::PositionBar( RECT FAR * rcBounds, INT nBarcodeWidth )
{
EFS_BEGIN
...
INT CSIBarcodeCtrl::FindChar( PATTERNS far * apat, INT c )
{
EFS_BEGIN
...
INT CSIBarcodeCtrl::DrawCharStr( CRect& rcBounds, PATTERNS far * apat, CDC * pdc, CBrush * brush, INT x, INT nBar, INT nScale, INT c )
{
EFS_BEGIN
	INT ic;
	INT i;
...
INT CSIBarcodeCtrl::LenCharStr( PATTERNS far * apat, INT c )
{
EFS_BEGIN
...
LPCTSTR CSIBarcodeCtrl::MapChar( MAPS far * pMap, LPCTSTR lpstr )
{
	INT c;
	INT i;
...
INT CSIBarcodeCtrl::DrawChar( CRect& rcBounds, PATTERNS far * apat, MAPS far * pMap, CDC * pdc, CBrush * brush, INT x, INT nBar, INT nScale, LPCTSTR lpstr )
{
EFS_BEGIN
	INT nLen;
	INT nLenNew;
...
INT CSIBarcodeCtrl::LenChar( PATTERNS far * apat, MAPS far * pMap, INT nScale, LPCTSTR lpstr )
{
EFS_BEGIN
...
INT CSIBarcodeCtrl::SymbolCountChar( PATTERNS far * apat, MAPS far * pMap, LPCTSTR lpstr )
{
EFS_BEGIN
...
INT CSIBarcodeCtrl::SymbolCount( PATTERNS far * apat, MAPS far * pMap, CString str )
{
EFS_BEGIN
	...
	for ( nLen = 0, iIndex = 0; iIndex < str.GetLength(); iIndex += 1 )
		nLen += SymbolCountChar( apat, pMap, str.GetBuffer( 0 ) + iIndex );
...
INT CSIBarcodeCtrl::BarWidth( INT nWidth, INT nBoxWidth )
{
EFS_BEGIN
...
INT CSIBarcodeCtrl::BarCodeWidth( INT iStyle, CString str )
{
EFS_BEGIN
	...
	{
		nWidth = LenChar( aStyles[ iStyle ].pPat, aStyles[ iStyle ].pMap, aStyles[ iStyle ].nScale, szStart );
...
VOID CSIBarcodeCtrl::UPCRectShrink( CRect& rc )
{
EFS_BEGIN
...
INT CSIBarcodeCtrl::NumericOnly( CString * str )
{
EFS_BEGIN
...
INT CSIBarcodeCtrl::AlphaNumericOnly( CString * str )
{
EFS_BEGIN
...
VOID CSIBarcodeCtrl::UPCChecksum( CString& str, INT nLength, INT iSeed )
{
EFS_BEGIN
	...
	str.SetAt( nLength, (TCHAR)((( 10 - ( j % 10 )) % 10 ) + '0' ));

EFS_END
}

VOID CSIBarcodeCtrl::PaintUPC( CDC * pdc, CBrush * brush, INT nLength, INT nWidth, INT nBar, CString& str, CRect& lprPaint, LPPATTERNS pPat, LPMAPS pMap, LPPATTERNS pEven, LPPATTERNS pOdd )
{
EFS_BEGIN
	INT i, ic;
	CRect rectShrink;
	...
	ic += DrawChar( lprPaint, pPat, pMap, pdc, brush, ic, nBar, 1, szStart );
	ic -= nBar;
	...
	{
		if ( i < ( nLength + 1 ) / 2 )
			ic += DrawChar( rectShrink, pOdd, pMap, pdc, brush, ic, nBar, 1, str.GetBuffer(0) + i );
		else
		{
			if ( i == ( nLength + 1 ) / 2 )
			{
				ic += DrawChar( lprPaint, pEven, pMap, pdc, brush, ic, nBar, 1, sz3 );
				ic -= nBar;
			}
								
			ic += DrawChar( rectShrink, pEven, pMap, pdc, brush, ic, nBar, 1, str.GetBuffer(0) + i );
		}
	...
	DrawChar( lprPaint, pPat, pMap, pdc, brush, ic, nBar, 1, szStop );

EFS_END
}

VOID CSIBarcodeCtrl::PaintEAN13( CDC * pdc, CBrush * brush, INT nWidth, INT nBar, CString& str, CRect& lprPaint, LPPATTERNS pPat, LPMAPS pMap )
{
EFS_BEGIN
	INT i, ic;
	CRect rectShrink;
	...
	for ( i = 1; i <= 12; i++ )
	{
		if ( i <= 6 )
		{
			if ( abEANParity[ str[0] - '0' ][ i-1 ] == 'A' )
				ic += DrawChar( rectShrink, aEANA, pMap, pdc, brush, ic, nBar, 1, str.GetBuffer(0) + i );
			else
				ic += DrawChar( rectShrink, aEANB, pMap, pdc, brush, ic, nBar, 1, str.GetBuffer(0) + i );
		}
		else
		{
			if ( i == 7 )
			{
				ic += DrawChar( lprPaint, pPat, pMap, pdc, brush, ic, nBar, 1, sz3 );
				ic -= nBar;
			}
								
			ic += DrawChar( rectShrink, aEANC, pMap, pdc, brush, ic, nBar, 1, str.GetBuffer(0) + i );
		}
...
INT CSIBarcodeCtrl::DigitCount( CString str )
{
EFS_BEGIN
...
INT CSIBarcodeCtrl::NextLCorCtrl( CString str )
{
EFS_BEGIN
...
INT CSIBarcodeCtrl::InStr( CString str, INT iType )
{
EFS_BEGIN
...
INT CSIBarcodeCtrl::BarWidth128( CString strCaption, BOOL fUCCEAN128 )
{
EFS_BEGIN
...
VOID CSIBarcodeCtrl::Generate128Auto( CString& strCaption, CString& strResult, CString& strDisplayed, BOOL fUCCEAN128 )
{
EFS_BEGIN
	...
	strResult = _T("");
	strDisplayed = _T("");
	iPos = InStr( strCaption, LCC_LOWERCASE );	// find 1st lowercase TCHAR
	...
	while ( index < strCaption.GetLength() )
	{
		...
		if ( InStr( strCaption[index], LCC_CONTROL ) >= 0 )
		{
			...
			strResult+=CString((TCHAR)FindChar(pPat,strCaption[index]));	// add the TCHAR as-is
...
VOID CSIBarcodeCtrl::PaintI2of5( CDC * pdc, CBrush * brush, INT nWidth, INT nBar, CString& str, CRect& lprPaint )
{
EFS_BEGIN
	INT ic;
	INT j;
	...
	ic = PositionBar( lprPaint, nWidth * nBar );
	ic += DrawChar( lprPaint, aI2of5, NULL, pdc, brush, ic, nBar, 1, szStart );
	...
	for ( i = 0; i < str.GetLength(); i += 2 )
	{
		...
		ic += DrawChar( lprPaint, aI2of5, NULL, pdc, brush, ic, nBar, 1, sz3 );
		ic -= nBar;
	}

	DrawChar( lprPaint, aI2of5, NULL, pdc, brush, ic, nBar, 1, szStop );

EFS_END
}

VOID CSIBarcodeCtrl::PaintDUN14( CDC * pdc, CBrush * brush, INT nWidth, INT nBar, CString& str, CRect& lprPaint )
{
EFS_BEGIN
	CString strOut;
	CString strTemp;
...
VOID CSIBarcodeCtrl::Paint128C( CDC * pdc, CBrush * brush, INT nWidth, INT nBar, CString& str, CRect& lprPaint )
{
EFS_BEGIN
	INT ic;
	long cs;
	...
	ic = PositionBar( lprPaint, nWidth * nBar );
	ic += DrawChar( lprPaint, aCode128C, NULL, pdc, brush, ic, nBar, 1, szStart );
	...
	for ( i = 0; i < str.GetLength(); i += 2 )
	{
		...
		ic += DrawChar( lprPaint, aCode128C, NULL, pdc, brush, ic, nBar, 1, sz );
	...
	DrawChar( lprPaint, aCode128C, NULL, pdc, brush, ic, nBar, 1, szStop );

EFS_END
}

VOID CSIBarcodeCtrl::Paint128Auto( CDC * pdc, CBrush * brush, INT nWidth, INT nBar, CString& str, CRect& lprPaint, BOOL fUCCEAN128 )
{
EFS_BEGIN
	CString strResult;
	CString strDisplayed;
...
VOID CSIBarcodeCtrl::PaintUPCE( CDC * pdc, CBrush * brush, INT nWidth, INT nBar, CString& str, CRect& lprPaint )
{
EFS_BEGIN
	CString strUPC;
	INT iNumberSystem;
	...
	// draw start bar
	ic = PositionBar( lprPaint, nWidth * nBar );
	ic += DrawChar( lprPaint, aUPCEEven, NULL, pdc, brush, ic, nBar, 1, szStart );
	...
	ic += DrawChar( lprPaint, aUPCEEven, NULL, pdc, brush, ic, nBar, 1, szStop );

EFS_END
}

VOID CSIBarcodeCtrl::PaintPostNet( CDC * pdc, CBrush * brush, INT nWidth, INT nBar, CString& str, CRect& lprPaint )
{
EFS_BEGIN
...
VOID CSIBarcodeCtrl::PaintRoyalMail( CDC * pdc, CBrush * brush, INT nWidth, INT nBar, CString& str, CRect& lprPaint )
{
EFS_BEGIN
	long nGap;
	long nxLogical, nyLogical;
...
VOID CSIBarcodeCtrl::Draw( CDC * pdc, CRect rcBounds )
{
EFS_BEGIN
	...
	if ( m_enumStyle )
	{
		...
		if ( aStyles[ iStyle ].iStyle != -1 )
		{
			...
			else if ( !aStyles[ iStyle ].fSpecial )
			{
				...
				ic += DrawChar( rectPaint, pPat, pMap, &dcOut, brFore, ic, nBar, aStyles[ iStyle ].nScale, szStart );
	
				for ( j = 0, i = 0; i < strCaption.GetLength(); i++ )
				{
					nWidth = DrawChar( rectPaint, pPat, pMap, &dcOut, brFore, ic, nBar, 
						aStyles[ iStyle ].nScale, strCaption.GetBuffer(0) + i );
...
VOID CSIBarcodeCtrl::DICopy( CDC* pdcDest, CDC* pdcSrc, const CRect* lpRect )
{
EFS_BEGIN
...
/////////////////////////////////////////////////////////////////////////////
// CSIBarcodeCtrl::OnResetState - Reset control to default state

VOID CSIBarcodeCtrl::GetCaption( CString & String )
{
EFS_BEGIN
...
VOID CSIBarcodeCtrl::SetCaption( CString & String )
{
EFS_BEGIN
...
VOID CSIBarcodeCtrl::OnResetState()
{
EFS_BEGIN
...
short CSIBarcodeCtrl::GetBarWidth()
{
EFS_BEGIN
...
VOID CSIBarcodeCtrl::SetBarWidth(short iBarWidth)
{
EFS_BEGIN
...
short CSIBarcodeCtrl::GetDirection()
{
EFS_BEGIN
...
VOID CSIBarcodeCtrl::SetDirection(short enumDirection)
{
EFS_BEGIN
...
VOID CSIBarcodeCtrl::SetStyle(short enumStyle)
{
EFS_BEGIN
...
/////////////////////////////////////////////////////////////////////////////
// CSIBarcodeCtrl message handlers
...
long CheckSumMSI( long cs, INT cChar, INT iOffset )
{
	...
	return CheckSumMSIString( szMSI, iOffset );
