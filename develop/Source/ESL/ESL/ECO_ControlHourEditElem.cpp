// ECO_ControlHourEditElem.cpp: implementation of the CECO_ControlHourEditElem class.
//
//////////////////////////////////////////////////////////////////////
...
CECO_ControlHourEditElem::CECO_ControlHourEditElem()
{
	m_pParent = NULL;
}
...
BEGIN_MESSAGE_MAP(CECO_ControlHourEditElem, CEdit)
	//{{AFX_MSG_MAP(CECO_ControlHourEditElem)
	ON_WM_CHAR()
	ON_WM_KILLFOCUS()
	ON_WM_KEYDOWN()
	//}}AFX_MSG_MAP
...
VOID CECO_ControlHourEditElem::SetParent(CECO_ControlHourEdit* pParent)
{
	EFS_BEGIN
		m_pParent = pParent;
	EFS_END
...
VOID CECO_ControlHourEditElem::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
EFS_BEGIN
...
VOID CECO_ControlHourEditElem::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
EFS_BEGIN
...
VOID CECO_ControlHourEditElem::OnKillFocus( CWnd* pNewWnd )
{
EFS_BEGIN
    CWnd* pDialog;
