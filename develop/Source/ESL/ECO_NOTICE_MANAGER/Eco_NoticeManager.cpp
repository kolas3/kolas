// Eco_NoticeManager.cpp : implementation file
//

#include "stdafx.h"
#include "Eco_NoticeManager.h"
...
CEco_NoticeManager::CEco_NoticeManager(CESL_Mgr* pParent /*=NULL*/)
	: CESL_Mgr(CEco_NoticeManager::IDD, pParent)
{
	//{{AFX_DATA_INIT(CEco_NoticeManager)
	m_FILE_INFO.FileCnt = 0;
	//}}AFX_DATA_INIT
}


VOID CEco_NoticeManager::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CEco_NoticeManager)
...
BEGIN_MESSAGE_MAP(CEco_NoticeManager, CDialog)
	//{{AFX_MSG_MAP(CEco_NoticeManager)
...
/////////////////////////////////////////////////////////////////////////////
// CEco_NoticeManager message handlers
BOOL CEco_NoticeManager::OnInitDialog()
{
...
INT CEco_NoticeManager::Display(INT nMode)
{
	if( nMode == 0 )
	{
...
VOID CEco_NoticeManager::OnbIDOK() 
{
...
////////////////////////////////////////////////////////////////////////////////////
INT CEco_NoticeManager::Input( CString RecKey, INT index, CString LibraryCode, CString LibraryName )
{
	CESL_DataMgr  * m_pDataMgr;
...
VOID CEco_NoticeManager::OnbSEARCH() 
{
...
INT CEco_NoticeManager::AllInputLibraryInfo(CString pLibraryCode, CString pLibraryName, CString pParentRecKey)
{
//	CESL_DataMgr  * m_pDataMgr;
	CString         RecKey;
	//INT             ids;
...
VOID CEco_NoticeManager::OnbINCLUDEFILE() 
{
	FILE    * fp;
	CString   strPathName;
	TCHAR      FileName[256];
...
INT CEco_NoticeManager::InsertFile_Proc( CESL_DataMgr * pDataMgr, CString pLocalFileRecKey, CString pParentRecKey ,CString ServerType ) 
{
	INT  i, ids;
...
VOID CEco_NoticeManager::OnbAPPEND() 
{
	CESL_DataMgr * m_pDataMgr;
...
INT CEco_NoticeManager::AllInput( CString pParentRecKey, CString pLocalLibraryCode, CString pLocalLibraryName )
{
	CESL_DataMgr  * m_pDataMgr;
...
INT CEco_NoticeManager::InitProgress (INT nRange)
{
...
INT CEco_NoticeManager::ChangeProgressCtrl(INT nRange)
{
	INT nLower, nUpper ;
...
VOID CEco_NoticeManager::OnSelchangeTab1(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
INT CEco_NoticeManager::GridDisplayEventProc(CString &strGridAlias, INT nRow, INT nCol, CString &strDMFieldAlias, CString &str)
{
...
VOID CEco_NoticeManager::OnCancel2() 
{
	EndDialog(1);	
}

INT CEco_NoticeManager::DoModal() 
{
