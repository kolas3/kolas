...
#if !defined(AFX_DLGHTMLEDIT_H__0E643CC8_6AC3_4931_8219_206CD3A848D0__INCLUDED_)
#define AFX_DLGHTMLEDIT_H__0E643CC8_6AC3_4931_8219_206CD3A848D0__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// DlgHtmlEdit.h : header file
//
...
class AFX_EXT_CLASS CDlgHtmlEdit : public CDialog
{
// Construction
public:
	void MoveWindow(CRect rec, BOOL bRepaint=FALSE);
	int m_nTabMode;

	void SetHtml(CString strHtml);
	CString GetHtml();
	void InitAllCtrl();
	BOOL OnButtonFontColor();
	BOOL OnButtonFontBackColor();
	BOOL InsertNewTable();
	CDlgHtmlEdit(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDlgHtmlEdit)	
	CWhiteBGTabCtrl mCtrl_Tab;
	...
	CButton	mCtrl_Split;
	CBitmapButton	mCtrl_Table;
	CButton	mCtrl_TableProp;
	CStatic	mCtrl_StaticEditor;
	CButton	mCtrl_CheckSource;
	CButton mCtrl_CheckDesign;
	CBitmapButton mCtrl_CheckBold;
	CBitmapButton mCtrl_CheckItalic;
	CBitmapButton mCtrl_CheckUnderline;
...
protected:
	...
	// Do not declare these variables as static in CHtmlEditDlg::OnMsgUpdateUI()
...
extern "C" __declspec(dllexport) BOOL CreateHtmlEditor(CDlgHtmlEdit* pDlgHtmlEdit, CWnd* pParent = NULL);

//{{AFX_INSERT_LOCATION}}
// Microsoft Visual C++ will insert additional declarations immediately before the previous line.

#endif // !defined(AFX_DLGHTMLEDIT_H__0E643CC8_6AC3_4931_8219_206CD3A848D0__INCLUDED_)
