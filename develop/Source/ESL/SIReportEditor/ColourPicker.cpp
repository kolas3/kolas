...
//
// This file is provided _T("as is") with no expressed or implied warranty.
...
BOOL CColourPicker::OnClicked()
{
    ...
    new CColourPopup(CPoint(rect.left, rect.bottom),    // Point to display popup
                     ...
                     this,                              // parent
                     m_strDefaultText,                  // _T("Default") text area
...
VOID CColourPicker::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct) 
{
    ...
    // Must reduce the size of the _T("client") area of the button due to edge thickness.
