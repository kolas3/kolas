...
CBO_CAT_REG_0420::~CBO_CAT_REG_0420()
{
...
VOID CBO_CAT_REG_0420::OnbOperationOK() 
{
	...
	CBO_CAT_REG_0410 Dlg(this);
	if (OperationType == 0)
	{
		Dlg.SetOperationType(OperationType);
		Dlg.CancelRegNo();
	}
	else if (OperationType == 1)
	{
...
HBRUSH CBO_CAT_REG_0420::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
