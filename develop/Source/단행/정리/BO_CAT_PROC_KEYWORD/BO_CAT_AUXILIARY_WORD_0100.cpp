// BO_CAT_AUXILIARY_WORD_0100.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CBO_CAT_AUXILIARY_WORD_0100 dialog


CBO_CAT_AUXILIARY_WORD_0100::CBO_CAT_AUXILIARY_WORD_0100(CESL_Mgr* pParent /*=NULL*/)
	: CESL_Mgr(IDD, pParent)
{
	//{{AFX_DATA_INIT(CBO_CAT_AUXILIARY_WORD_0100)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}

CBO_CAT_AUXILIARY_WORD_0100::~CBO_CAT_AUXILIARY_WORD_0100()
{
}

VOID CBO_CAT_AUXILIARY_WORD_0100::DoDataExchange(CDataExchange* pDX)
{
EFS_BEGIN

	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CBO_CAT_AUXILIARY_WORD_0100)
...
BEGIN_MESSAGE_MAP(CBO_CAT_AUXILIARY_WORD_0100, CDialog)
	//{{AFX_MSG_MAP(CBO_CAT_AUXILIARY_WORD_0100)
	ON_WM_CTLCOLOR()
...
/////////////////////////////////////////////////////////////////////////////
// CBO_CAT_AUXILIARY_WORD_0100 message handlers

BOOL CBO_CAT_AUXILIARY_WORD_0100::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
{
EFS_BEGIN
...
BOOL CBO_CAT_AUXILIARY_WORD_0100::OnInitDialog() 
{
EFS_BEGIN
	...
	if (InitESL_Mgr(_T("BO_CAT_AUXILIARY_WORD_0100")) < 0)
	{
...
VOID CBO_CAT_AUXILIARY_WORD_0100::OnbSEARCH() 
{
EFS_BEGIN

	// TODO: Add your control notification handler code here
	CString sWord;
	GetControlData( _T("CM_BO_CAT_AUXILIARY_WORD_0100"), _T("조사"), sWord );
	if ( sWord.IsEmpty() ){
...
VOID CBO_CAT_AUXILIARY_WORD_0100::OnbINPUT() 
{
EFS_BEGIN

	// TODO: Add your control notification handler code here
	CBO_CAT_AUXILIARY_WORD_0200 dlg(this);
	//dlg.DoModal();
	if ( dlg.DoModal() == IDOK ) {
		m_bModifyFlag = true;
	}
...
VOID CBO_CAT_AUXILIARY_WORD_0100::OnbUPDATE() 
{
EFS_BEGIN

	// TODO: Add your control notification handler code here
	CBO_CAT_AUXILIARY_WORD_0300 dlg(this);
	//dlg.DoModal();
	if ( dlg.DoModal() == IDOK ) {
		m_bModifyFlag = true;
	}
...
VOID CBO_CAT_AUXILIARY_WORD_0100::OnbDELETE() 
{
EFS_BEGIN
	...
	INT idx = SelectGetTailPosition(_T("CM_BO_CAT_AUXILIARY_WORD_0100"), _T("GRD_AUXILIARY"));
	if (idx < 0)
	{
...
/*
		...
		CString sQuery;
		sQuery.Format( _T("DELETE FROM CO_AUXILIARY_WORD_TBL WHERE REC_KEY IN (%s);") , sAccRecKey );
...
*/
	...
	AllControlDisplay(_T("CM_BO_CAT_AUXILIARY_WORD_0100"));
...
VOID CBO_CAT_AUXILIARY_WORD_0100::OnCancel() 
{
EFS_BEGIN
	...
	if ( m_bModifyFlag > 0 ) {
		CESL_DataMgr *pDM;
		pDM = FindDM( _T("DM_BO_CAT_PROC_0390_AuxWord") );
		if ( pDM == NULL ) {
			AfxMessageBox( _T("DM_BO_CAT_PROC_0390_AuxWord error") );
			return;
		}

		CESL_DataMgr *m_pDM_Manage;
		m_pDM_Manage = FindDM( _T("DM_BO_CAT_PROC_0390_AuxWord") );
...
BOOL CBO_CAT_AUXILIARY_WORD_0100::PreTranslateMessage(MSG* pMsg) 
{
...
HBRUSH CBO_CAT_AUXILIARY_WORD_0100::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
