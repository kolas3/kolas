...
CBO_CAT_PROC_0320_FORM_10::CBO_CAT_PROC_0320_FORM_10(CESL_Mgr* pParent, CString s007 /*=NULL*/)
...
CBO_CAT_PROC_0320_FORM_10::~CBO_CAT_PROC_0320_FORM_10()
{
}
...
EFS_BEGIN
	...
	if ( m_s007 != _T("") &&  i007Len == 2 ) {
		...
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_10"), _T("자료식별표시"), sItemData);		
	}
...
BOOL CBO_CAT_PROC_0320_FORM_10::PreTranslateMessage(MSG* pMsg) 
{
EFS_BEGIN
	...
	if ( pMsg->message == WM_KEYDOWN && pMsg->wParam == VK_F9 ) {
		...
		if (dlg.DoModal() == IDOK) {			
			...
			SetControlData( _T("CM_BO_CAT_PROC_0320_FORM_10"), sControlAlias, sCode );			
		}
		return true;
	}
		...
		CString sData;
		GetControlData( _T("CM_BO_CAT_PROC_0320_FORM_10"), sControlAlias, sData );
		...
		if ( bFind == FALSE && sData != _T("") ) {
			...
			SetControlData( _T("CM_BO_CAT_PROC_0320_FORM_10"), sControlAlias, _T("") );
			//return true;
...
HBRUSH CBO_CAT_PROC_0320_FORM_10::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
