...
CBO_CAT_PROC_0320_FORM_09::CBO_CAT_PROC_0320_FORM_09(CESL_Mgr* pParent, CString s007 /*=NULL*/)
...
CBO_CAT_PROC_0320_FORM_09::~CBO_CAT_PROC_0320_FORM_09()
{
}
...
EFS_BEGIN
	...
	if ( m_s007 != _T("") &&  i007Len == 9 ) {
		...
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_09"), _T("자료식별표시"), sItemData);
		sItemData = m_s007.Mid(2,1);
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_09"), _T("원본상태"), sItemData);
		sItemData = m_s007.Mid(3,1);
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_09"), _T("색채"), sItemData);
		sItemData = m_s007.Mid(4,1);
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_09"), _T("비디오녹화형식"), sItemData);
		sItemData = m_s007.Mid(5,1);
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_09"), _T("매체의음향수록"), sItemData);
		sItemData = m_s007.Mid(6,1);
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_09"), _T("음향수록매체"), sItemData);
		sItemData = m_s007.Mid(7,1);
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_09"), _T("크기"), sItemData);
		sItemData = m_s007.Mid(8,1);
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_09"), _T("음향의재생상태"), sItemData);
	}
...
BOOL CBO_CAT_PROC_0320_FORM_09::PreTranslateMessage(MSG* pMsg) 
{
EFS_BEGIN
	...
	if ( pMsg->message == WM_KEYDOWN && pMsg->wParam == VK_F9 ) {
		...
		UINT wndCodeID[ 8 ] = {
			...
			IDC_cVIDEO_FORM, IDC_cMUSIC_CONTENTS, IDC_cMUSIC_MAT,
			IDC_cSIZE, IDC_cPLAY_LEVEL
		};		
		...
		if (dlg.DoModal() == IDOK) {			
			...
			SetControlData( _T("CM_BO_CAT_PROC_0320_FORM_09"), sControlAlias, sCode );			
		}
		return true;
	}
		...
		CString sData;
		GetControlData( _T("CM_BO_CAT_PROC_0320_FORM_09"), sControlAlias, sData );
		...
		if ( bFind == FALSE && sData != _T("") ) {
			...
			SetControlData( _T("CM_BO_CAT_PROC_0320_FORM_09"), sControlAlias, _T("") );
			//return true;
...
HBRUSH CBO_CAT_PROC_0320_FORM_09::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
