...
CBO_CAT_PROC_0320_FORM_01::CBO_CAT_PROC_0320_FORM_01(CESL_Mgr* pParent, CString s007 /*=NULL*/)
...
CBO_CAT_PROC_0320_FORM_01::~CBO_CAT_PROC_0320_FORM_01()
{
}
...
EFS_BEGIN
	...
	if ( m_s007 != _T("") && m_s007.GetLength() == 8 ) {
		CString sItemData = m_s007.Mid(1,1);
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_01"), _T("자료식별표시"), sItemData);
		sItemData = m_s007.Mid(2,1);
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_01"), _T("원본상태"), sItemData);
		sItemData = m_s007.Mid(3,1);
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_01"), _T("색채"), sItemData);
		sItemData = m_s007.Mid(4,1);
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_01"), _T("물리적매체"), sItemData);
		sItemData = m_s007.Mid(5,1);
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_01"), _T("복제형태"), sItemData);
		sItemData = m_s007.Mid(6,1);
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_01"), _T("복제내용"), sItemData);
		sItemData = m_s007.Mid(7,1);
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_01"), _T("감광상태"), sItemData);
	}
...
BOOL CBO_CAT_PROC_0320_FORM_01::PreTranslateMessage(MSG* pMsg) 
{
EFS_BEGIN
	...
	if ( pMsg->message == WM_KEYDOWN && pMsg->wParam == VK_F9 ) {
		...
		UINT wndCodeID[ 7 ] = {
			...
			IDC_cCOPY_FORM, IDC_cCOPY_CONTENTS, IDC_cEXPOSURE_LEVEL			
		};		
		...
		if (dlg.DoModal() == IDOK) {			
			...
			SetControlData( _T("CM_BO_CAT_PROC_0320_FORM_01"), sControlAlias, sCode );
		...
		CString sData;
		GetControlData( _T("CM_BO_CAT_PROC_0320_FORM_01"), sControlAlias, sData );
		...
		if ( bFind == FALSE && sData != _T("") ) {
			...
			SetControlData( _T("CM_BO_CAT_PROC_0320_FORM_01"), sControlAlias, _T("") );
			//return true;
...
HBRUSH CBO_CAT_PROC_0320_FORM_01::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
