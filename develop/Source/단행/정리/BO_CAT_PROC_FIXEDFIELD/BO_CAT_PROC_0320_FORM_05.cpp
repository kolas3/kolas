...
CBO_CAT_PROC_0320_FORM_05::CBO_CAT_PROC_0320_FORM_05(CESL_Mgr* pParent, CString s007 /*=NULL*/)
...
CBO_CAT_PROC_0320_FORM_05::~CBO_CAT_PROC_0320_FORM_05()
{
}
...
EFS_BEGIN
	...
	if ( m_s007 != _T("") &&  i007Len == 6 ) {
		...
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_05"), _T("자료식별표시"), sItemData);
		sItemData = m_s007.Mid(2,1);
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_05"), _T("원본상태"), sItemData);
		sItemData = m_s007.Mid(3,1);
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_05"), _T("색채"), sItemData);
		sItemData = m_s007.Mid(4,1);
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_05"), _T("기본재료"), sItemData);
		sItemData = m_s007.Mid(5,1);
		SetControlData(_T("CM_BO_CAT_PROC_0320_FORM_05"), _T("틀의재질"), sItemData);		
	}
...
BOOL CBO_CAT_PROC_0320_FORM_05::PreTranslateMessage(MSG* pMsg) 
{
EFS_BEGIN
	...
	if ( pMsg->message == WM_KEYDOWN && pMsg->wParam == VK_F9 ) {
		...
		UINT wndCodeID[ 5 ] = {
			...
			IDC_cCOLOR, IDC_cBASIC_MAT, IDC_cFORMULA_MAT
		};		
		...
		if (dlg.DoModal() == IDOK) {			
			...
			SetControlData( _T("CM_BO_CAT_PROC_0320_FORM_05"), sControlAlias, sCode );
		...
		CString sData;
		GetControlData( _T("CM_BO_CAT_PROC_0320_FORM_05"), sControlAlias, sData );
		...
		if ( bFind == FALSE && sData != _T("") ) {
			...
			SetControlData( _T("CM_BO_CAT_PROC_0320_FORM_05"), sControlAlias, _T("") );
			//return true;
...
HBRUSH CBO_CAT_PROC_0320_FORM_05::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
