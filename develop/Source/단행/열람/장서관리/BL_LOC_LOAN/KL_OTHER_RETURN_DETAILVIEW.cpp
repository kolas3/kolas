// KL_OTHER_RETURN_DETAILVIEW.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CKL_OTHER_RETURN_DETAILVIEW dialog


CKL_OTHER_RETURN_DETAILVIEW::CKL_OTHER_RETURN_DETAILVIEW(CESL_Mgr* pParent /*=NULL*/)
	: CESL_Mgr(CKL_OTHER_RETURN_DETAILVIEW::IDD, pParent)
{
	//{{AFX_DATA_INIT(CKL_OTHER_RETURN_DETAILVIEW)
...
void CKL_OTHER_RETURN_DETAILVIEW::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CKL_OTHER_RETURN_DETAILVIEW)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CKL_OTHER_RETURN_DETAILVIEW, CDialog)
	//{{AFX_MSG_MAP(CKL_OTHER_RETURN_DETAILVIEW)
...
/////////////////////////////////////////////////////////////////////////////
// CKL_OTHER_RETURN_DETAILVIEW message handlers

BOOL CKL_OTHER_RETURN_DETAILVIEW::OnInitDialog() 
{
	...
	else
	{
		...
		m_pGrid->m_strPrintInfo = _T("타관반납관리 이용자상세보기");
	}
...
void CKL_OTHER_RETURN_DETAILVIEW::OnButtonClose() 
{
...
void CKL_OTHER_RETURN_DETAILVIEW::OnButtonNext() 
{
	// TODO: Add your control notification handler code here
	++m_nCur;
...
void CKL_OTHER_RETURN_DETAILVIEW::OnButtonPre() 
{
	// TODO: Add your control notification handler code here
	--m_nCur;
...
void CKL_OTHER_RETURN_DETAILVIEW::GetData()
{
	if(m_nCur < 0)
	{
		m_pDM->FreeData();
...
void CKL_OTHER_RETURN_DETAILVIEW::RefreshData()
{
	m_nCur = 0;	
...
void CKL_OTHER_RETURN_DETAILVIEW::RefreshControl()
{	
	if(m_nCur <= 0)
	{
