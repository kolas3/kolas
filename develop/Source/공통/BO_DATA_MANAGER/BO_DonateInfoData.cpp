// BO_DonateInfoData.cpp: implementation of the CBO_DonateInfoData class.
//
//////////////////////////////////////////////////////////////////////

#include "stdafx.h"
#include "BO_DonateInfoData.h"
...
CBO_DonateInfoData::CBO_DonateInfoData(CESL_Mgr * pParentMgr) : CBO_BusinessData(pParentMgr)
{

}

CBO_DonateInfoData::~CBO_DonateInfoData()
{

}

INT CBO_DonateInfoData::ApplyDM(CESL_DataMgr * pDM, INT nIdx)
{
...
INT CBO_DonateInfoData::ApplyMarcToData(CMarc * pMarc)
{
...
INT CBO_DonateInfoData::ApplyDataToMarc(CMarc * pMarc)
{
	if(pMarc == NULL || m_pParentMgr == NULL || m_pDM == NULL) return -1;
	if(m_pDM->GetRowCount() == 0) return 0;
