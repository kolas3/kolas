// Index_NonBook.cpp: implementation of the CIndex_NonBook class.
//
//////////////////////////////////////////////////////////////////////

#include "stdafx.h"
#include "Index_NonBook.h"
...
INT CIndex_NonBook::GetIndex(CString strIndexAlias, CString &strIndexItem)
{
...
INT CIndex_NonBook::GetIndex_BookTitleFile(CString strIndexAlias, CString &strIndexItem)
{		
	INT ids;
	...
	while (posTag != NULL)
	{
		...
		if (pTag->GetTagCode() == _T("130") || pTag->GetTagCode() == _T("240") ||
			...
			pTag->GetTagCode() == _T("940")	|| pTag->GetTagCode() == _T("630") ||
			pTag->GetTagCode() == _T("650")	|| pTag->GetTagCode() == _T("651") ||
			pTag->GetTagCode() == _T("653")	)

		{
			...
			while (posSubfield != NULL)
			{
				...
				if (strSubfieldCode == _T("$a") || 
					...
					strSubfieldCode == _T("$y") ||
					strSubfieldCode == _T("$z"))
				{	
					strTemp2 = pSubfield->GetItemData();
					
					if (pTag->GetTagCode() == _T("130") ||
						pTag->GetTagCode() == _T("240") ||
						pTag->GetTagCode() == _T("730") ||
						pTag->GetTagCode() == _T("740")
						)
					{
						if (strSecondInd == _T("1"))
							RemoveAllParenthesis(strTemp2);
					}
					else if (pTag->GetTagCode() == _T("630"))
					{
						if (strFirstInd == _T("1"))
							RemoveAllParenthesis(strTemp2);
					}
...
INT CIndex_NonBook::GetIndex_Author(CString strIndexAlias, CString &strIndexItem)
{
	CString strTemp1, strTemp2, strTemp3;
	POSITION posTag;
	...
	while (posTag != NULL)
	{
		CTag *pTag = (CTag*)GetMarc()->m_listTag.GetNext(posTag);
		if (pTag == NULL) continue;
		if (pTag->GetTagCode() == _T("100") || 
			pTag->GetTagCode() == _T("700") || 
			pTag->GetTagCode() == _T("900") ||
			pTag->GetTagCode() == _T("600"))
		{
			strTemp1.Empty();
			strTemp2.Empty();
			strTemp3.Empty();
	...
	while (posTag != NULL)
	{
		CTag *pTag = (CTag*)GetMarc()->m_listTag.GetNext(posTag);
		if (pTag == NULL) continue;
		if (pTag->GetTagCode() == _T("110") || 
			pTag->GetTagCode() == _T("710") || 
			pTag->GetTagCode() == _T("910") ||
			pTag->GetTagCode() == _T("610")
			)
		{
			strTemp1.Empty();
			strTemp2.Empty();
	...
	while (posTag != NULL)
	{
		CTag *pTag = (CTag*)GetMarc()->m_listTag.GetNext(posTag);
		if (pTag == NULL) continue;
		if (pTag->GetTagCode() == _T("111") || 
			pTag->GetTagCode() == _T("711") || 
			pTag->GetTagCode() == _T("911") ||
			pTag->GetTagCode() == _T("611") 
			)
		{
			strTemp1.Empty();
...
INT CIndex_NonBook::GetIndex_ClassCode(CString strIndexAlias, CString &strIndexItem)
{
	CString strTemp1, strTemp2, strTemp3;
	POSITION posTag;
	...
	while (posTag != NULL)
	{
		CTag *pTag = (CTag*)GetMarc()->m_listTag.GetNext(posTag);
		if (pTag == NULL) continue;
		if (pTag->GetTagCode() == _T("056") || pTag->GetTagCode() == _T("080"))
		{
			strTemp1.Empty();
...
INT CIndex_NonBook::GetIndex_Keyword(CString strIndexAlias, CString &strIndexItem)
{
	CString strTemp1, strTemp2, strTemp3;
	POSITION posTag;
...
INT CIndex_NonBook::GetIndex_StandardCode(CString strIndexAlias, CString &strIndexItem)
{
	CString strTemp1, strTemp2, strTemp3;
	POSITION posTag;
...
INT CIndex_NonBook::GetIndex_Publisher(CString strIndexAlias, CString &strIndexItem)
{
	CString strTemp1, strTemp2, strTemp3;
	POSITION posTag;
...
INT CIndex_NonBook::GetIndex_KRUnivCode(CString strIndexAlias, CString &strIndexItem)
{
...
INT CIndex_NonBook::GetIndex_GovCode(CString strIndexAlias, CString &strIndexItem)
{
...
INT CIndex_NonBook::GetIndex_SealWord(CString strIndexAlias, CString &strIndexItem)
{
...
INT CIndex_NonBook::GetIndex_SummaryWord(CString strIndexAlias, CString &strIndexItem)
{
	CString strTemp1, strTemp2, strTemp3;
	POSITION posTag;
...
INT CIndex_NonBook::GetIndex_TextWord(CString strIndexAlias, CString &strIndexItem)
{
	CString strTemp1, strTemp2, strTemp3;
	POSITION posTag;
...
INT CIndex_NonBook::GetIndex_SchoolCourse(CString strIndexAlias, CString &strIndexItem)
{
	CString strTemp1, strTemp2, strTemp3;
	POSITION posTag;
...
INT CIndex_NonBook::GetIndex_PublishYear(CString strIndexAlias, CString &strIndexItem)
{
	CString strTemp1, strTemp2, strTemp3;
...
INT CIndex_NonBook::GetIndex_ISBN(CString strIndexAlias, CString &strIndexItem)
{
	CString strTemp1, strTemp2, strTemp3;
...
INT CIndex_NonBook::GetIndex_ITITLE(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_IPUBLISHER(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_ST_CODE(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_ST_ISSN(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_ST_STRN(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_ST_RNSTRN(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_CBN(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_CAN(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_SE_SHELF_CODE(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_CLASS_NO(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_BOOK_CODE(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_VOL_CODE(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_VOL_CODE_DISP(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
	ids = m_pMarcMgr->GetItem(m_pMarc, _T("090$c"), strIndexItem);
	if (ids < 0) return -1;
...
INT CIndex_NonBook::GetIndex_CONTROL_NO(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_KDCP_CLASS(CString strIndexAlias, CString &strIndexItem)
{
	CTag *pTag = NULL;
...
INT CIndex_NonBook::GetIndex_KDCCLASS(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_DDC_CLASS(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_CEC_CLASS(CString strIndexAlias, CString &strIndexItem)
{
	CTag *pTag = NULL;
	POSITION posTag = m_pMarc->m_listTag.GetHeadPosition();
	while (posTag)
...
INT CIndex_NonBook::GetIndex_CWC_CLASS(CString strIndexAlias, CString &strIndexItem)
{
	CTag *pTag = NULL;
	POSITION posTag = m_pMarc->m_listTag.GetHeadPosition();
	while (posTag)
...
INT CIndex_NonBook::GetIndex_COC_CLASS(CString strIndexAlias, CString &strIndexItem)
{
	CTag *pTag = NULL;
	POSITION posTag = m_pMarc->m_listTag.GetHeadPosition();
	while (posTag)
...
INT CIndex_NonBook::GetIndex_UDC_CLASS(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_NDC_CLASS(CString strIndexAlias, CString &strIndexItem)
{
	CTag *pTag = NULL;
	POSITION posTag = m_pMarc->m_listTag.GetHeadPosition();
	while (posTag)
...
INT CIndex_NonBook::GetIndex_LC_CLASS(CString strIndexAlias, CString &strIndexItem)
{
	CTag *pTag = NULL;
	POSITION posTag = m_pMarc->m_listTag.GetHeadPosition();
	while (posTag)
...
INT CIndex_NonBook::GetIndex_ETC_CLASS(CString strIndexAlias, CString &strIndexItem)
{
	CTag *pTag = NULL;
	POSITION posTag = m_pMarc->m_listTag.GetHeadPosition();
	while (posTag)
...
INT CIndex_NonBook::GetIndex_EDIT(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_IPUB_YEAR(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_JANGJUNG(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_BookTitleInfo(CString strIndexAlias, CString &strIndexItem)
{
...
INT CIndex_NonBook::GetIndex_TITLE_INFO(CString strIndexAlias, CString &strIndexItem)
{
	CString strPunctuationMark;
	POSITION posTag = GetMarc()->m_listTag.GetHeadPosition();
	while (posTag != NULL)
...
INT CIndex_NonBook::GetIndex_AUTHOR_INFO(CString strIndexAlias, CString &strIndexItem)
{
	CString strPunctuationMark;
	POSITION posTag = GetMarc()->m_listTag.GetHeadPosition();
	while (posTag != NULL)
...
INT CIndex_NonBook::GetIndex_PUB_INFO(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
	ids = m_pMarcMgr->GetItem(m_pMarc, _T("260$b"), strIndexItem);
	if (ids < 0) return -1;
...
INT CIndex_NonBook::GetIndex_PUB_YEAR_INFO(CString strIndexAlias, CString &strIndexItem)
{
	INT ids;
...
INT CIndex_NonBook::GetIndex_Subject(CString strIndexAlias, CString &strIndexItem)
{
	CString strTemp1, strTemp2, strTemp3;
	POSITION posTag;
	...
	while (posTag != NULL)
	{
		...
		if (pTag->GetTagCode() == _T("610"))
		{
			...
			while (posSubfield != NULL)
			{
				...
				if (strSubfieldCode == _T("$a") || strSubfieldCode == _T("$b") || strSubfieldCode == _T("$g") || strSubfieldCode == _T("$k") )
				{
					strTemp1 += pSubfield->GetItemData();
					strTemp1.MakeUpper();
					RemoveSpace(strTemp1);
