// Group_DataView_Dlg.cpp : implementation file
//

#include "stdafx.h"
#include "Group_DataView_Dlg.h"
...
/////////////////////////////////////////////////////////////////////////////
// CGroup_DataView_Dlg dialog


CGroup_DataView_Dlg::CGroup_DataView_Dlg(CESL_Mgr* pParent /*=NULL*/)
	: CESL_Mgr(CGroup_DataView_Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CGroup_DataView_Dlg)
...
CGroup_DataView_Dlg::~CGroup_DataView_Dlg()
{
}

VOID CGroup_DataView_Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CGroup_DataView_Dlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CGroup_DataView_Dlg, CDialog)
	//{{AFX_MSG_MAP(CGroup_DataView_Dlg)
	ON_BN_CLICKED(IDC_btnGROUP_NO_INFO_PREV, OnbtnGROUPNOINFOPREV)
	ON_BN_CLICKED(IDC_btnGROUP_NO_INFO_NEXT, OnbtnGROUPNOINFONEXT)
	ON_WM_CTLCOLOR()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CGroup_DataView_Dlg message handlers

BOOL CGroup_DataView_Dlg::OnInitDialog() 
{
...
VOID CGroup_DataView_Dlg::Display(INT idx)
{
	INT ids;
	CString errstr;
...
VOID CGroup_DataView_Dlg::InitFirstLastIndex()
{
	CESL_Grid * pGrid = (CESL_Grid*)m_pMainCM->FindControl(_T("MainGrid"));
...
VOID CGroup_DataView_Dlg::ShowNextPrevButton(INT idx)
{
...
INT CGroup_DataView_Dlg::GetTotalPriceAndBookCount()
{
	CString str64;
...
INT CGroup_DataView_Dlg::GridDisplayEventProc(CString &strGridAlias, INT nRow, INT nCol, CString &strDMFieldAlias, CString &str)
{
...
INT CGroup_DataView_Dlg::MakeDM()
{
	CString strAcqYear, strReqNo, strTotalPrice, strBookCnt;
	m_pCM->GetControlMgrData(_T("수입년도"), strAcqYear);
	m_pCM->GetControlMgrData(_T("그룹번호"), strReqNo);
...
VOID CGroup_DataView_Dlg::OnbtnGROUPNOINFOPREV() 
{
	// TODO: Add your control notification handler code here
	Display(-1);		
}

VOID CGroup_DataView_Dlg::OnbtnGROUPNOINFONEXT() 
{
	// TODO: Add your control notification handler code here
	Display(1);		
}

HBRUSH CGroup_DataView_Dlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{	
