...
//
// _T("GotoURL") function by Stuart Patterson
...
//
// _T("Default hand cursor") from Paul DiLascia's Jan 1998 MSJ article.
//
...
VOID CHyperLink::PreSubclassWindow() 
{
    ...
    SetDefaultCursor();      // Try and load up a _T("hand") cursor
    SetUnderline();
...
// It loads a _T("hand") cursor from the winhlp32.exe module
...
VOID CHyperLink::ReportError(INT nError)
{
    CString str;
    switch (nError) {
        case 0:                       str = _T("The operating _tsystem is out\nof memory or resources."); break;
        ...
        case SE_ERR_ACCESSDENIED:     str = _T("The operating _tsystem denied\naccess to the specified file."); break;
