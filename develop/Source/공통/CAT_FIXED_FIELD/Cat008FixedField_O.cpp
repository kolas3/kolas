// Cat008FixedField_O.cpp : implementation file
//

#include "stdafx.h"
#include "Cat008FixedField_O.h"
...
/////////////////////////////////////////////////////////////////////////////
// CCat008FixedField_O dialog


CCat008FixedField_O::CCat008FixedField_O(CESL_Mgr* pParent /*=NULL*/, CMarc *pMarc /*=NULL*/)
	: CCat008FixedFieldMgr(IDD, pParent)
{
	//{{AFX_DATA_INIT(CCat008FixedField_O)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT

	m_pMarc = pMarc;
}
CCat008FixedField_O::~CCat008FixedField_O()
{
}

VOID CCat008FixedField_O::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCat008FixedField_O)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CCat008FixedField_O, CDialog)
	//{{AFX_MSG_MAP(CCat008FixedField_O)
...
/////////////////////////////////////////////////////////////////////////////
// CCat008FixedField_O Operations

INT CCat008FixedField_O::InitData()
{
...
/////////////////////////////////////////////////////////////////////////////
// CCat008FixedField_O message handlers

BOOL CCat008FixedField_O::OnInitDialog() 
{
...
BOOL CCat008FixedField_O::PreTranslateMessage(MSG* pMsg) 
{
	return CCat008FixedFieldMgr::PreTranslateMessage(pMsg);
}

VOID CCat008FixedField_O::Onb007EDIT() 
{
...
HBRUSH CCat008FixedField_O::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
