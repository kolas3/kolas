// Cat008FixedField_MP.cpp : implementation file
//

#include "stdafx.h"
#include "Cat008FixedField_MP.h"
...
/////////////////////////////////////////////////////////////////////////////
// CCat008FixedField_MP dialog


CCat008FixedField_MP::CCat008FixedField_MP(CESL_Mgr* pParent /*=NULL*/, CMarc *pMarc /*=NULL*/)
	: CCat008FixedFieldMgr(IDD, pParent)
{
	//{{AFX_DATA_INIT(CCat008FixedField_MP)
...
CCat008FixedField_MP::~CCat008FixedField_MP()
{
}

VOID CCat008FixedField_MP::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCat008FixedField_MP)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CCat008FixedField_MP, CDialog)
	//{{AFX_MSG_MAP(CCat008FixedField_MP)
...
/////////////////////////////////////////////////////////////////////////////
// CCat008FixedField_MP Operations

INT CCat008FixedField_MP::InitData()
{
	...
	m_mapMarcAlias_ControlAlias.SetAt(_T("008@18"),_T("모형도1"));
	m_mapMarcAlias_ControlAlias.SetAt(_T("008@19"),_T("모형도2"));
	m_mapMarcAlias_ControlAlias.SetAt(_T("008@20"),_T("모형도3"));
	m_mapMarcAlias_ControlAlias.SetAt(_T("008@21"),_T("모형도4"));
	m_mapMarcAlias_ControlAlias.SetAt(_T("008@22-23"),_T("도법"));
	m_mapMarcAlias_ControlAlias.SetAt(_T("008@24"),_T("본초자오선"));
	m_mapMarcAlias_ControlAlias.SetAt(_T("008@25"),_T("자료의형태"));
	...
	m_mapMarcAlias_ControlAlias.SetAt(_T("008@33"),_T("형태상의특징1"));
	m_mapMarcAlias_ControlAlias.SetAt(_T("008@34"),_T("형태상의특징2"));
	...
	m_mapControlAlias_ItemName.SetAt(_T("본초자오선"), _T("(본초자오선)"));
	m_mapControlAlias_ItemName.SetAt(_T("자료의형태"), _T("(지도자료형태)"));
	m_mapControlAlias_ItemName.SetAt(_T("색인"), _T("(색인)"));
	m_mapControlAlias_ItemName.SetAt(_T("형태상의특징1"), _T("(형태상특징)"));
	m_mapControlAlias_ItemName.SetAt(_T("형태상의특징2"), _T("(형태상특징)"));
...
/////////////////////////////////////////////////////////////////////////////
// CCat008FixedField_MP message handlers

BOOL CCat008FixedField_MP::OnInitDialog() 
{
	...
	m_pCM = FindCM(_T("CM_BO_CAT_PROC_0322"));
	if (!m_pCM) goto ERR;
...
BOOL CCat008FixedField_MP::PreTranslateMessage(MSG* pMsg) 
{
	return CCat008FixedFieldMgr::PreTranslateMessage(pMsg);
}

VOID CCat008FixedField_MP::Onb007EDIT() 
{
...
HBRUSH CCat008FixedField_MP::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
