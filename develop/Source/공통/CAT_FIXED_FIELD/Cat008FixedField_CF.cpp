// Cat008FixedField_CF.cpp : implementation file
//

#include "stdafx.h"
#include "Cat008FixedField_CF.h"
...
/////////////////////////////////////////////////////////////////////////////
// CCat008FixedField_CF dialog


CCat008FixedField_CF::CCat008FixedField_CF(CESL_Mgr* pParent /*=NULL*/, CMarc *pMarc /*=NULL*/)
	: CCat008FixedFieldMgr(IDD, pParent)
{
	//{{AFX_DATA_INIT(CCat008FixedField_CF)
...
CCat008FixedField_CF::~CCat008FixedField_CF()
{
}

VOID CCat008FixedField_CF::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCat008FixedField_CF)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CCat008FixedField_CF, CDialog)
	//{{AFX_MSG_MAP(CCat008FixedField_CF)
...
/////////////////////////////////////////////////////////////////////////////
// CCat008FixedField_CF Operations

INT CCat008FixedField_CF::InitData()
{
	m_strGroupName = _T("[CF]");
	...
	m_mapMarcAlias_ControlAlias.SetAt(_T("008@25"),_T("컴퓨터파일유형"));
	...
	m_mapControlAlias_ItemName.SetAt(_T("이용수준"), _T("(이용대상자수준)"));
	m_mapControlAlias_ItemName.SetAt(_T("컴퓨터파일유형"), _T("(컴퓨터파일유형)"));
...
/////////////////////////////////////////////////////////////////////////////
// CCat008FixedField_CF message handlers

BOOL CCat008FixedField_CF::OnInitDialog() 
{
	...
	m_pCM = FindCM(_T("CM_BO_CAT_PROC_0321"));
	if (!m_pCM) goto ERR;
...
BOOL CCat008FixedField_CF::PreTranslateMessage(MSG* pMsg) 
{
	return CCat008FixedFieldMgr::PreTranslateMessage(pMsg);
}

VOID CCat008FixedField_CF::Onb007EDIT() 
{
...
HBRUSH CCat008FixedField_CF::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
