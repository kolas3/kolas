...
CRedirect::CRedirect(LPCTSTR	szCommand,
					 CEdit		*pEdit,
...
VOID CRedirect::Run()
{
	...
	Success = CreateProcess( NULL,					// pointer to name of executable module
							 ...
							 NULL,					// pointer to thread security attributes 
							 						// 		(use primary thread security attributes)
	...
	{ 
		...
		if ( NumBytesRead )
		{
			...
			//	assume it is the last output from the batch file and _tremove it.
			//------------------------------------------------------------------
...
VOID CRedirect::ShowLastError(LPCTSTR szText)
{
	...
	//--------------------------------------------------------------------------
	//	Get the _tsystem error message.
	//--------------------------------------------------------------------------
