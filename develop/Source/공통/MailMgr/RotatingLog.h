...
// Document modified at : Monday, June 10, 2002 12:02:32 PM , by user : Administrator , from computer : GJPARK
// RotatingLog.h: interface for the CRotatingLog class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_ROTATINGLOG_H__CD3C1515_1B53_11D5_B625_F78604D34C23__INCLUDED_)
#define AFX_ROTATINGLOG_H__CD3C1515_1B53_11D5_B625_F78604D34C23__INCLUDED_
...
// [6/4/2002] =============================================================
	...
	// [6/10/2002] CRotatingLog(const CString &File, BOOL bMakeDateFilename=!DATE_FILE_NAME, UINT MaxLines=9999, UINT LineLength=1024);
	CRotatingLog(const CString &File, BOOL bMakeDateFilename=!DATE_FILE_NAME, UINT nOpenFlags=CFile::shareExclusive, UINT MaxLines=9999, UINT LineLength=1024);
...
protected:	
	BOOL	Open();
	CString MakeDateFilename(const CString &Filename);

public:
	BOOL	AddLine(const CString& Line, BOOL bWriteDateTime=TIME_LOG, BOOL bNewLine=NEW_LINE);
	BOOL	StartAddLineStop(const CString& Line, BOOL bWriteDateTime=TIME_LOG, BOOL bNewLine=NEW_LINE);
	BOOL	StartAddLine(const CString& Line, BOOL bWriteDateTime=TIME_LOG, BOOL bNewLine=NEW_LINE);
	BOOL	AddLineStop(const CString& Line, BOOL bWriteDateTime=TIME_LOG, BOOL bNewLine=NEW_LINE);

	BOOL	GetDumpLine(UINT &count, CString &line);
	UINT	GetDumpStart(BOOL bForward);
...
// [6/4/2002] =============================================================
	...
	VOID	SetRotateLineLimit(UINT MaxLines, UINT LineLength);

	///Log file path 가져오기
	inline CString GetLogFilepath()		{ return this->m_FilePath;	};
...
#endif // !defined(AFX_ROTATINGLOG_H__CD3C1515_1B53_11D5_B625_F78604D34C23__INCLUDED_)
