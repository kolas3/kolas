...
//////////////////
// Override navigation handler to pass to _T("app:") links to virtual handler.
...
//////////////////
// Called when the browser attempts to navigate to _T("app:foo")
// with _T("foo") as lpszWhere. Override to handle app commands.
//
