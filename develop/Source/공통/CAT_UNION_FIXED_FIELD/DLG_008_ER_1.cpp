// DLG_008_ER_1.cpp : implementation file
// 2017/08/25 : 2017년 공공도서관 책이음서비스 확대구축 및 시스템개선
// 통합마크 개정 적용

#include "stdafx.h"
#include "resource.h"
#include "DLG_008_ER_1.h"
...
/////////////////////////////////////////////////////////////////////////////
// CDLG_008_ER_1 dialog


CDLG_008_ER_1::CDLG_008_ER_1(CESL_Mgr* pParent /*=NULL*/, CMarc *pMarc /*=NULL*/)
	: CCat008UnionFixedFieldMgr(IDD, pParent)
{
	//{{AFX_DATA_INIT(CDLG_008_ER_1)
...
CDLG_008_ER_1::~CDLG_008_ER_1()
{
}

void CDLG_008_ER_1::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDLG_008_ER_1)
...
BEGIN_MESSAGE_MAP(CDLG_008_ER_1, CDialog)
	//{{AFX_MSG_MAP(CDLG_008_ER_1)
...
/////////////////////////////////////////////////////////////////////////////
// CDLG_008_ER_1 message handlers

BOOL CDLG_008_ER_1::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
{
...
INT CDLG_008_ER_1::InitData()
{
	...
	m_mapMarcAlias_ControlAlias.SetAt(_T("008@25"),_T("전자자료의유형"));			
...
BOOL CDLG_008_ER_1::OnInitDialog() 
{
	CDialog::OnInitDialog();
	
	if (InitESL_Mgr(_T("SM_FIXED_008_ER_1")) < 0)
	{
		m_strLastErrMsg = _T("InitESL_Mgr Error");
		goto ERR;
	}
	
	m_pCM = FindCM(_T("CM_FIXED_008_ER_1"));
	if (!m_pCM) goto ERR;
...
BOOL CDLG_008_ER_1::PreTranslateMessage(MSG* pMsg) 
{
	return CCat008UnionFixedFieldMgr::PreTranslateMessage(pMsg);
}

void CDLG_008_ER_1::Onb007EDIT() 
{
...
HBRUSH CDLG_008_ER_1::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
