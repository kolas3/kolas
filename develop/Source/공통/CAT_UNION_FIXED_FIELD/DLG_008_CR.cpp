// DLG_008_CR.cpp : implementation file
//

#include "stdafx.h"
#include "resource.h"
#include "DLG_008_CR.h"
...
CDLG_008_CR::CDLG_008_CR(CESL_Mgr* pParent /*=NULL*/, CMarc *pMarc /*=NULL*/)
	: CCat008UnionFixedFieldMgr(IDD, pParent)
{
	//{{AFX_DATA_INIT(CDLG_008_CR)
...
CDLG_008_CR::~CDLG_008_CR()
{
}
void CDLG_008_CR::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDLG_008_CR)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDLG_008_CR, CDialog)
	//{{AFX_MSG_MAP(CDLG_008_CR)
...
/////////////////////////////////////////////////////////////////////////////
// CDLG_008_CR message handlers


BOOL CDLG_008_CR::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
{
...
BOOL CDLG_008_CR::OnInitDialog() 
{
	CDialog::OnInitDialog();
	
	if (InitESL_Mgr(_T("SM_FIXED_008_CR")) < 0)
	{
		m_strLastErrMsg = _T("InitESL_Mgr Error");
		goto ERR;
	}
	
	m_pCM = FindCM(_T("CM_FIXED_008_CR"));
	if (!m_pCM) goto ERR;
...
BOOL CDLG_008_CR::PreTranslateMessage(MSG* pMsg) 
{
...
HBRUSH CDLG_008_CR::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
