// DLG_008_VM.cpp : implementation file
//

#include "stdafx.h"
#include "resource.h"
#include "DLG_008_VM.h"
...
CDLG_008_VM::CDLG_008_VM(CESL_Mgr* pParent /*=NULL*/, CMarc *pMarc /*=NULL*/)
	: CCat008UnionFixedFieldMgr(IDD, pParent)
{
	//{{AFX_DATA_INIT(CDLG_008_VM)
...
CDLG_008_VM::~CDLG_008_VM()
{
}

void CDLG_008_VM::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDLG_008_VM)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDLG_008_VM, CDialog)
	//{{AFX_MSG_MAP(CDLG_008_VM)
...
/////////////////////////////////////////////////////////////////////////////
// CDLG_008_VM message handlers

BOOL CDLG_008_VM::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
{
...
BOOL CDLG_008_VM::OnInitDialog() 
{
	CDialog::OnInitDialog();
	
	if (InitESL_Mgr(_T("SM_FIXED_008_VM")) < 0)
	{
		m_strLastErrMsg = _T("InitESL_Mgr Error");
		goto ERR;
	}
	
	m_pCM = FindCM(_T("CM_FIXED_008_VM"));
	if (!m_pCM) goto ERR;
...
BOOL CDLG_008_VM::PreTranslateMessage(MSG* pMsg) 
{
	return CCat008UnionFixedFieldMgr::PreTranslateMessage(pMsg);
}

void CDLG_008_VM::OnKillfocuseFIXED00811() 
{
...
HBRUSH CDLG_008_VM::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
