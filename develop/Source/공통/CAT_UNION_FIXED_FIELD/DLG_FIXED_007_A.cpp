// DLG_FIXED_007_A.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CDLG_FIXED_007_A dialog


CDLG_FIXED_007_A::CDLG_FIXED_007_A(CESL_Mgr* pParent /*=NULL*/, CMarc *pMarc /*=NULL*/)
	: CCat007UnionFixedFieldMgr(IDD, pParent)
{
	//{{AFX_DATA_INIT(CDLG_FIXED_007_A)
...
CDLG_FIXED_007_A::~CDLG_FIXED_007_A()
{
}

void CDLG_FIXED_007_A::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDLG_FIXED_007_A)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDLG_FIXED_007_A, CDialog)
	//{{AFX_MSG_MAP(CDLG_FIXED_007_A)
	ON_WM_CTLCOLOR()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDLG_FIXED_007_A message handlers
INT CDLG_FIXED_007_A::InitData()
{
	...
	m_mapMarcAlias_ControlAlias.SetAt(_T("007@6"),_T("제작/복제내용"));
	...
	m_mapControlAlias_ItemName.SetAt(_T("물리적매체"), _T("(물리적매체(재질))"));
	m_mapControlAlias_ItemName.SetAt(_T("복제유형"), _T("(복제유형)"));
	m_mapControlAlias_ItemName.SetAt(_T("제작/복제내용"), _T("(제작/복제내용)"));
...
INT CDLG_FIXED_007_A::Get007()
{
	...
	arrStrControlAlias.Add(_T("제작/복제내용"));
...
BOOL CDLG_FIXED_007_A::OnInitDialog() 
{
	CDialog::OnInitDialog();

	if (InitESL_Mgr(_T("SM_FIXED_007_A")) < 0)
	{
		AfxMessageBox(_T("InitESL_Mgr Error"));
		return FALSE;
	}

	m_pCM = FindCM(_T("CM_FIXED_007_A"));
	if (!m_pCM) goto ERR;
...
BOOL CDLG_FIXED_007_A::PreTranslateMessage(MSG* pMsg) 
{
	return CCat007UnionFixedFieldMgr::PreTranslateMessage(pMsg);
}

BOOL CDLG_FIXED_007_A::Create(CWnd *pParentWnd)
{
	return CDialog::Create(IDD, pParentWnd);
}

HBRUSH CDLG_FIXED_007_A::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
