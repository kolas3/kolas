// DLG_008_ER.cpp : implementation file
//

#include "stdafx.h"
#include "resource.h"
#include "DLG_008_ER.h"
...
CDLG_008_ER::CDLG_008_ER(CESL_Mgr* pParent /*=NULL*/, CMarc *pMarc /*=NULL*/)
	: CCat008UnionFixedFieldMgr(IDD, pParent)
{
	//{{AFX_DATA_INIT(CDLG_008_ER)
...
CDLG_008_ER::~CDLG_008_ER()
{
}

void CDLG_008_ER::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDLG_008_ER)
...
BEGIN_MESSAGE_MAP(CDLG_008_ER, CDialog)
	//{{AFX_MSG_MAP(CDLG_008_ER)
...
/////////////////////////////////////////////////////////////////////////////
// CDLG_008_ER message handlers

BOOL CDLG_008_ER::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
{
...
BOOL CDLG_008_ER::OnInitDialog() 
{
	CDialog::OnInitDialog();
	
	if (InitESL_Mgr(_T("SM_FIXED_008_ER")) < 0)
	{
		m_strLastErrMsg = _T("InitESL_Mgr Error");
		goto ERR;
	}
	
	m_pCM = FindCM(_T("CM_FIXED_008_ER"));
	if (!m_pCM) goto ERR;
...
BOOL CDLG_008_ER::PreTranslateMessage(MSG* pMsg) 
{
	return CCat008UnionFixedFieldMgr::PreTranslateMessage(pMsg);
}

void CDLG_008_ER::Onb007EDIT() 
{
...
HBRUSH CDLG_008_ER::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
