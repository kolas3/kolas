// DLG_008_MX.cpp : implementation file
//

#include "stdafx.h"
#include "resource.h"
#include "DLG_008_MX.h"
...
CDLG_008_MX::CDLG_008_MX(CESL_Mgr* pParent /*=NULL*/, CMarc *pMarc /*=NULL*/)
	: CCat008UnionFixedFieldMgr(IDD, pParent)
{
	//{{AFX_DATA_INIT(CDLG_008_MX)
...
CDLG_008_MX::~CDLG_008_MX()
{
}
void CDLG_008_MX::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDLG_008_MX)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDLG_008_MX, CDialog)
	//{{AFX_MSG_MAP(CDLG_008_MX)
...
/////////////////////////////////////////////////////////////////////////////
// CDLG_008_MX message handlers

BOOL CDLG_008_MX::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
{
...
BOOL CDLG_008_MX::OnInitDialog() 
{
	CDialog::OnInitDialog();
	
	if (InitESL_Mgr(_T("SM_FIXED_008_MX")) < 0)
	{
		m_strLastErrMsg = _T("InitESL_Mgr Error");
		goto ERR;
	}
	
	m_pCM = FindCM(_T("CM_FIXED_008_MX"));
	if (!m_pCM) goto ERR;
...
BOOL CDLG_008_MX::PreTranslateMessage(MSG* pMsg) 
{
	return CCat008UnionFixedFieldMgr::PreTranslateMessage(pMsg);
}

void CDLG_008_MX::Onb007EDIT() 
{
...
HBRUSH CDLG_008_MX::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
