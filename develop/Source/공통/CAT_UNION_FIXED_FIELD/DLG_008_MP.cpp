// DLG_008_MP.cpp : implementation file
//

#include "stdafx.h"
#include "resource.h"
#include "DLG_008_MP.h"
...
CDLG_008_MP::CDLG_008_MP(CESL_Mgr* pParent /*=NULL*/, CMarc *pMarc /*=NULL*/)
	: CCat008UnionFixedFieldMgr(IDD, pParent)
{
	//{{AFX_DATA_INIT(CDLG_008_MP)
...
CDLG_008_MP::~CDLG_008_MP()
{
}

void CDLG_008_MP::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDLG_008_MP)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDLG_008_MP, CDialog)
	//{{AFX_MSG_MAP(CDLG_008_MP)
...
/////////////////////////////////////////////////////////////////////////////
// CDLG_008_MP message handlers

BOOL CDLG_008_MP::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
{
...
INT CDLG_008_MP::InitData()
{
	...
	m_mapMarcAlias_ControlAlias.SetAt(_T("008@29"),_T("자료의형태"));	
...
BOOL CDLG_008_MP::OnInitDialog() 
{
	CDialog::OnInitDialog();
	
	if (InitESL_Mgr(_T("SM_FIXED_008_MP")) < 0)
	{
		m_strLastErrMsg = _T("InitESL_Mgr Error");
		goto ERR;
	}
	
	m_pCM = FindCM(_T("CM_FIXED_008_MP"));
	if (!m_pCM) goto ERR;
...
BOOL CDLG_008_MP::PreTranslateMessage(MSG* pMsg) 
{
	return CCat008UnionFixedFieldMgr::PreTranslateMessage(pMsg);
}

void CDLG_008_MP::Onb007EDIT() 
{
...
HBRUSH CDLG_008_MP::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
