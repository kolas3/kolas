// DLG_008_MU.cpp : implementation file
//

#include "stdafx.h"
#include "resource.h"
#include "DLG_008_MU.h"
...
CDLG_008_MU::CDLG_008_MU(CESL_Mgr* pParent /*=NULL*/, CMarc *pMarc /*=NULL*/)
	: CCat008UnionFixedFieldMgr(IDD, pParent)
{
	//{{AFX_DATA_INIT(CDLG_008_MU)
...
CDLG_008_MU::~CDLG_008_MU()
{
}
void CDLG_008_MU::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDLG_008_MU)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDLG_008_MU, CDialog)
	//{{AFX_MSG_MAP(CDLG_008_MU)
...
/////////////////////////////////////////////////////////////////////////////
// CDLG_008_MU message handlers

BOOL CDLG_008_MU::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
{
...
BOOL CDLG_008_MU::OnInitDialog() 
{
	CDialog::OnInitDialog();
	
	if (InitESL_Mgr(_T("SM_FIXED_008_MU")) < 0)
	{
		m_strLastErrMsg = _T("InitESL_Mgr Error");
		goto ERR;
	}
	
	m_pCM = FindCM(_T("CM_FIXED_008_MU"));
	if (!m_pCM) goto ERR;
...
BOOL CDLG_008_MU::PreTranslateMessage(MSG* pMsg) 
{
	return CCat008UnionFixedFieldMgr::PreTranslateMessage(pMsg);
}

void CDLG_008_MU::Onb007EDIT() 
{
...
HBRUSH CDLG_008_MU::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
