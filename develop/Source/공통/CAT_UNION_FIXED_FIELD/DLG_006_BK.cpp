// DLG_006_BK.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CDLG_006_BK dialog
CDLG_006_BK::CDLG_006_BK(CESL_Mgr* pParent /*=NULL*/, CMarc *pMarc /*=NULL*/)
	: CCat006UnionFixedFieldMgr(IDD, pParent)
{
	//{{AFX_DATA_INIT(CDLG_006_BK)
...
CDLG_006_BK::~CDLG_006_BK()
{
}

void CDLG_006_BK::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDLG_006_BK)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDLG_006_BK, CDialog)
	//{{AFX_MSG_MAP(CDLG_006_BK)
...
/////////////////////////////////////////////////////////////////////////////
// CDLG_006_BK message handlers
INT CDLG_006_BK::InitData()
{
...
BOOL CDLG_006_BK::OnInitDialog() 
{
	CDialog::OnInitDialog();

	if (InitESL_Mgr(_T("SM_FIXED_006_BK")) < 0)
	{
		AfxMessageBox(_T("InitESL_Mgr Error"));
		return FALSE;
	}

	m_pCM = FindCM(_T("CM_FIXED_006_BK"));
	if (!m_pCM) goto ERR;
...
BOOL CDLG_006_BK::PreTranslateMessage(MSG* pMsg) 
{
	return CCat006UnionFixedFieldMgr::PreTranslateMessage(pMsg);
}

BOOL CDLG_006_BK::Create(CWnd *pParentWnd)
{
	return CDialog::Create(IDD, pParentWnd);
}

void CDLG_006_BK::Onb007EDIT() 
{
	// TODO: Add your control notification handler code here
	
}

HBRUSH CDLG_006_BK::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
