// DLG_008_MU_1.cpp : implementation file
// 2017/08/25 : 2017년 공공도서관 책이음서비스 확대구축 및 시스템개선
// 통합마크 개정 적용

#include "stdafx.h"
#include "resource.h"
#include "DLG_008_MU_1.h"
...
/////////////////////////////////////////////////////////////////////////////
// CDLG_008_MU_1 dialog


CDLG_008_MU_1::CDLG_008_MU_1(CESL_Mgr* pParent /*=NULL*/, CMarc *pMarc /*=NULL*/)
	: CCat008UnionFixedFieldMgr(IDD, pParent)
{
	//{{AFX_DATA_INIT(CDLG_008_MU_1)
...
CDLG_008_MU_1::~CDLG_008_MU_1()
{
}
void CDLG_008_MU_1::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDLG_008_MU_1)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDLG_008_MU_1, CDialog)
	//{{AFX_MSG_MAP(CDLG_008_MU_1)
...
/////////////////////////////////////////////////////////////////////////////
// CDLG_008_MU_1 message handlers

BOOL CDLG_008_MU_1::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
{
...
INT CDLG_008_MU_1::InitData()
{
	...
	// 자료별	
	m_mapMarcAlias_ControlAlias.SetAt(_T("008@18-19"),_T("작곡형식"));	
	m_mapMarcAlias_ControlAlias.SetAt(_T("008@20"),_T("악보형식"));	
	m_mapMarcAlias_ControlAlias.SetAt(_T("008@21"),_T("악보파트보"));
	...
	m_mapMarcAlias_ControlAlias.SetAt(_T("008@33"),_T("조옮김및편곡"));
	...
	m_mapControlAlias_ItemName.SetAt(_T("악보파트보")		, _T("(악보 파트보)"));
...
BOOL CDLG_008_MU_1::OnInitDialog() 
{
	CDialog::OnInitDialog();
	
	if (InitESL_Mgr(_T("SM_FIXED_008_MU_1")) < 0)
	{
		m_strLastErrMsg = _T("InitESL_Mgr Error");
		goto ERR;
	}
	
	m_pCM = FindCM(_T("CM_FIXED_008_MU_1"));
	if (!m_pCM) goto ERR;
...
BOOL CDLG_008_MU_1::PreTranslateMessage(MSG* pMsg) 
{
	return CCat008UnionFixedFieldMgr::PreTranslateMessage(pMsg);
}

void CDLG_008_MU_1::Onb007EDIT() 
{
...
HBRUSH CDLG_008_MU_1::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
