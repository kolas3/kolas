// BO_CAT_REG_SEARCH_POPUP1.cpp : implementation file
//

#include "stdafx.h"
#include "BO_CAT_REG_SEARCH_POPUP1.h"
...
VOID CBO_CAT_REG_SEARCH_POPUP::OnbtnREGSEARCH2() 
{
	...
	*/
	...
	m_pSearchDlg->ShowWindow(SW_SHOW);	
	//m_pSearchDlg->GetControlData(_T("CM_BO_CAT_REG_SEARCH_0100"), _T("총책수"), sRowCount);
...
{
	//============================================
	//2008.07.08 REM BY PJW : delete 메모리 에러 수정.
//	m_pSearchDlg = m_pTmpSearchDlg;
