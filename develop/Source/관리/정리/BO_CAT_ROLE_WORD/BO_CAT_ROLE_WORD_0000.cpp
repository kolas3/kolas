// BO_CAT_ROLE_WORD_0000.cpp : implementation file
//

#include "stdafx.h"
#include "stdafx.h"
#include "BO_CAT_ROLE_WORD_0000.h"
...
/////////////////////////////////////////////////////////////////////////////
// CBO_CAT_ROLE_WORD_0000 dialog


CBO_CAT_ROLE_WORD_0000::CBO_CAT_ROLE_WORD_0000(CESL_Mgr* pParent /*=NULL*/)
	: CESL_Mgr(IDD, pParent)
{
	//{{AFX_DATA_INIT(CBO_CAT_ROLE_WORD_0000)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}

CBO_CAT_ROLE_WORD_0000::~CBO_CAT_ROLE_WORD_0000()
{
	m_Dlg_brush.DeleteObject();
}

VOID CBO_CAT_ROLE_WORD_0000::DoDataExchange(CDataExchange* pDX)
{
EFS_BEGIN

	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CBO_CAT_ROLE_WORD_0000)
...
BEGIN_MESSAGE_MAP(CBO_CAT_ROLE_WORD_0000, CDialog)
	//{{AFX_MSG_MAP(CBO_CAT_ROLE_WORD_0000)
	ON_WM_SIZE()
	ON_WM_CTLCOLOR()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
/////////////////////////////////////////////////////////////////////////////
// CBO_CAT_ROLE_WORD_0000 message handlers

BOOL CBO_CAT_ROLE_WORD_0000::Create(CWnd* pParentWnd)
{
EFS_BEGIN
...
VOID CBO_CAT_ROLE_WORD_0000::OnSize(UINT nType, INT cx, INT cy) 
{
EFS_BEGIN
	...
	CMSHFlexGrid *pGrid = (CMSHFlexGrid*)GetDlgItem(IDC_GRD_ROLE);
...
BOOL CBO_CAT_ROLE_WORD_0000::OnInitDialog() 
{
EFS_BEGIN
	...
	if (InitESL_Mgr(_T("BO_CAT_MNG_ROLE")) < 0)
	{
...
INT CBO_CAT_ROLE_WORD_0000::Delete()
{
EFS_BEGIN
	...
	INT idx = SelectGetTailPosition(_T("CM_BO_CAT_MNG_ROLE"), _T("GRD_ROLE"));
	if (idx < 0)
	{
...
*/
	...
	AllControlDisplay(_T("CM_BO_CAT_MNG_ROLE"));
...
VOID CBO_CAT_ROLE_WORD_0000::CreateFile()
{
	EFS_BEGIN
	...
	if ( pDM == NULL ) {
		AfxMessageBox( _T("DM_BO_CAT_MNG_ROLE_FILE error") );
		return;
	}

	CESL_DataMgr *m_pDM_Manage;
	m_pDM_Manage = FindDM( _T("DM_BO_CAT_MNG_ROLE_FILE") );
...
HBRUSH CBO_CAT_ROLE_WORD_0000::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
	HBRUSH hbr=NULL;
