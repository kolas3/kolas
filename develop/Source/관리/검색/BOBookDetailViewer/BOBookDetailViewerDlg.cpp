// BOBookDetailViewerDlg.cpp : implementation file

#include "stdafx.h"
#include "stdafx.h"
#include "BOBookDetailViewerDlg.h"
#include "BOBookMarcViewer.h"
#include "BOBookAppViewer.h"
#include "..\..\..\공통\k2up_common\isbnchecker.h"
// eBook 작업
#include "..\..\..\공통\COMMON_EBOOK_API\EBookViewMgr.h"
...
/////////////////////////////////////////////////////////////////////////////
// CBOBookDetailViewerDlg dialog

#define RECORD_TERMINATOR	29  //0x1d  양쪽방향 화살표
#define FIELD_TERMINATOR	30  //0x1e  삼각형
#define SUBFIELD_CODE		31  //0x1f  역삼각형
CBOBookDetailViewerDlg::CBOBookDetailViewerDlg(CESL_Mgr* pParent /*=NULL*/)
	: CESL_Mgr(IDD, pParent)
{
	//{{AFX_DATA_INIT(CBOBookDetailViewerDlg)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT

	m_pkCnt = 0;
}
CBOBookDetailViewerDlg::~CBOBookDetailViewerDlg()
{
	FreeAllInfo();
}

BOOL CBOBookDetailViewerDlg::Create(CWnd* pParentWnd)
{	
EFS_BEGIN
...
VOID CBOBookDetailViewerDlg::DoDataExchange(CDataExchange* pDX)
{
EFS_BEGIN

	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CBOBookDetailViewerDlg)
...
BEGIN_MESSAGE_MAP(CBOBookDetailViewerDlg, CDialog)
	//{{AFX_MSG_MAP(CBOBookDetailViewerDlg)
	ON_WM_SHOWWINDOW()
	ON_WM_CLOSE()
	...
	ON_BN_CLICKED(IDC_bEBOOK, OnbEBOOK)
	ON_WM_CTLCOLOR()
	ON_WM_NCACTIVATE()
	ON_BN_CLICKED(IDC_btnBoDetailViewClose, OnbtnBoDetailViewClose)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CBOBookDetailViewerDlg message handlers

BOOL CBOBookDetailViewerDlg::OnInitDialog() 
{
EFS_BEGIN
	...
	if( InitESL_Mgr( _T("MNG_BUSINESS_SEARCHER_03") ) < 0 )
	{
...
VOID CBOBookDetailViewerDlg::OnShowWindow(BOOL bShow, UINT nStatus) 
{
EFS_BEGIN
...
INT CBOBookDetailViewerDlg::ShowBODetailView()
{
EFS_BEGIN
	...
	CESL_DataMgr *pDM;
	pDM = FindDM( _T("DM_MNG_BUSINESS_SEARCHER_03_BO") );
	INT ids = pDM->RefreshDataManager( where );

	pDM = FindDM( _T("DM_MNG_BUSINESS_SEARCHER_03_BO_BOOK") );
	ids = pDM->RefreshDataManager( where );

	m_bookRow = -1;
	ShowControls();
	
	CButton *pBtn = ( CButton * )GetDlgItem( IDC_bEBOOK );
	pBtn->ShowWindow( false );
...
VOID CBOBookDetailViewerDlg::OnClose() 
{
EFS_BEGIN
...
VOID CBOBookDetailViewerDlg::FreeAllInfo()
{
EFS_BEGIN
...
VOID CBOBookDetailViewerDlg::ShowControls()
{
EFS_BEGIN

	
	SetCodeToDesc();
	ControlDisplay( _T("CM_MNG_BUSINESS_SEARCHER_03"), _T("그리드") );
...
VOID CBOBookDetailViewerDlg::ViewMarcInfo()
{
EFS_BEGIN
/*
	SetMarc();
...
VOID CBOBookDetailViewerDlg::SetMarc()
{
EFS_BEGIN
...
TCHAR CBOBookDetailViewerDlg::GetBookType()
{
	CString leader;
	TCHAR type;
...
VOID CBOBookDetailViewerDlg::ShowBOBookInfo()
{
EFS_BEGIN
...
VOID CBOBookDetailViewerDlg::ShowOldBookInfo()
{
EFS_BEGIN
...
VOID CBOBookDetailViewerDlg::ShowNonBookInfo()
{
EFS_BEGIN
...
VOID CBOBookDetailViewerDlg::ShowMarcInfo()
{
EFS_BEGIN
	...
	SetDisplayData();
	ControlDisplay( _T("CM_MNG_BUSINESS_SEARCHER_03"), _T("그리드_2") );
	SetMarcGridProperty();

EFS_END
}

INT CBOBookDetailViewerDlg::GetSubFieldInfo(CTag *pTag, CString subFieldCode)
{
EFS_BEGIN
...
VOID CBOBookDetailViewerDlg::AddMarcInfo(CString title, CString ind, INT tag)
{
EFS_BEGIN
...
VOID CBOBookDetailViewerDlg::FreeMarcInfoDM()
{
EFS_BEGIN
...
INT CBOBookDetailViewerDlg::ConvertBOBookInfo()
{
EFS_BEGIN
...
INT CBOBookDetailViewerDlg::ConvertOldBookInfo()
{
EFS_BEGIN
...
INT CBOBookDetailViewerDlg::ConvertNonBookInfo()
{
EFS_BEGIN
...
VOID CBOBookDetailViewerDlg::SetDisplayData()
{
EFS_BEGIN
...
VOID CBOBookDetailViewerDlg::SetMarcGridProperty()
{
EFS_BEGIN
/*
...
VOID CBOBookDetailViewerDlg::FreeTagInfo()
{
EFS_BEGIN
...
VOID CBOBookDetailViewerDlg::AllTrim(CString &data)
{
EFS_BEGIN
...
CString CBOBookDetailViewerDlg::RemoveParenthesis(CString data)
{
EFS_BEGIN
...
VOID CBOBookDetailViewerDlg::AddToMarcInfoDM(CString title, CString contents)
{
EFS_BEGIN
...
INT CBOBookDetailViewerDlg::GetMultiLineText(INT length, CString &contents)
{
EFS_BEGIN
...
INT CBOBookDetailViewerDlg::SetDataPK( CString pk, INT option )
{
EFS_BEGIN
...
VOID CBOBookDetailViewerDlg::OnbMARC() 
{
EFS_BEGIN
	...
	CBOBookMarcViewer dlg( this );
	dlg.DoModal();

EFS_END
}

VOID CBOBookDetailViewerDlg::OnbAPPENDIX() 
{
EFS_BEGIN
...
VOID CBOBookDetailViewerDlg::ShowWorkStatus( CString status )
{
EFS_BEGIN
...
CString CBOBookDetailViewerDlg::GetWorkStatusDesc( CString status )
{
EFS_BEGIN
...
VOID CBOBookDetailViewerDlg::SetCodeToDesc()
{
EFS_BEGIN


	CESL_DataMgr *pDM = FindDM( _T("DM_MNG_BUSINESS_SEARCHER_03_BO_BOOK") );
...
CString CBOBookDetailViewerDlg::GetShelfCode( CString data[] )
{
EFS_BEGIN
...
VOID CBOBookDetailViewerDlg::OnbBEFORE() 
{
EFS_BEGIN
...
VOID CBOBookDetailViewerDlg::OnbNEXT() 
{
EFS_BEGIN
...
VOID CBOBookDetailViewerDlg::SetPKList( CStringList &pkList, CESL_Grid *grid, CArray< INT, INT > &gridRow, INT idx )
{
EFS_BEGIN
...
INT CBOBookDetailViewerDlg::DisplaySpecies()
{
	EFS_BEGIN

	INT ids;
	
	CString sDMAlias = _T("DM_MNG_BUSINESS_SEARCHER_03_BO");
	...
	for( INT i = 0 ; i < nFieldCnt ; i++ )
	{
		...
		if( i == 5 )
		{
			CISBNChecker ISBNCheck;
			INT nResult;
			TCHAR sISBNResult[10000];
			ISBNCheck.ConvertISBN( sData.GetBuffer(0) , sISBNResult , &nResult );
			sData = sISBNResult;
		}
...
VOID CBOBookDetailViewerDlg::OnbEBOOK() 
{
	// TODO: Add your control notification handler code here
	...
	CEBookViewMgr mgr;
	mgr.EBookViewByBookKey( pDM->GetCellData( _T("B_REC_KEY"), pGrid->GetRow() - 1 ), pDM->CONNECTION_INFO );
}

VOID CBOBookDetailViewerDlg::ViewEBookBtn()
{
	if( m_pInfo->MODE == 10000 || m_pInfo->MODE == 30000 )
		return;
	...
	if( !row )
		pBtn->ShowWindow( false );
	else if( _T("EB") == pDM->GetCellData( _T("매체구분_CODE"), row - 1 ) )
		pBtn->ShowWindow( true );
	else
		pBtn->ShowWindow( false );
}

BEGIN_EVENTSINK_MAP(CBOBookDetailViewerDlg, CDialog)
    //{{AFX_EVENTSINK_MAP(CBOBookDetailViewerDlg)
	ON_EVENT(CBOBookDetailViewerDlg, IDC_mngGRID_1, -600 /* Click */, OnClickmngGRID1, VTS_NONE)
	//}}AFX_EVENTSINK_MAP
END_EVENTSINK_MAP()

VOID CBOBookDetailViewerDlg::OnClickmngGRID1() 
{
	// TODO: Add your control notification handler code here
...
HBRUSH CBOBookDetailViewerDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
...
LRESULT CBOBookDetailViewerDlg::WindowProc(UINT message, WPARAM wParam, LPARAM lParam) 
{	
	return CDialog::WindowProc(message, wParam, lParam);
}

BOOL CBOBookDetailViewerDlg::OnNcActivate(BOOL bActive) 
{
	return CDialog::OnNcActivate(bActive);
}

void CBOBookDetailViewerDlg::OnbtnBoDetailViewClose() 
{
	OnCancel();	
}
