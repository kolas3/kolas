...
public:
	...
	static bool ZipFolder(LPCTSTR szFilePath, bool bIgnoreFilePath, CString strStartDate, CString strEndDate); // saves as same name with .zip

	//=======================
	//2008.10.10 ADD BY PJW : 압축 시작날짜,마지막날짜 저장
	CString m_strStartDate;
	CString m_strEndDate;
	bool SetStratDate(CString strStartDate);
	bool SetEndDate(CString strEndDate);
	//=======================
